...
#include "Phy4_ColDetectionExtra.h"
...
void PrintStatusEntries()
{
	...
	NCLDebug::AddStatusEntry(status_colour, "     Atmosphere: %s (Press V to toggle)", SceneManager::Instance()->GetVsyncEnabled() ? "Enabled " : "Disabled");
