...
public:
	...
	inline bool					IsCollide()					const	{ return colFlag; }
	//Yupei
	inline bool					IsProjectile()				const	{ return projectileFlag; }
	inline bool					IsInAtmosphere()			const	{ return inAtmosphereFlag; }
	inline bool					IsTargetBoard()				const	{ return targetBoardFlag; }
	inline bool					IsFirstCol()				const	{ return firstColFlag; }

	//06/12/2016
	//Yupei
	inline bool					GetRestState()				const   { return restFlag; }
	...
	//Yupei
	inline void SetRestState(bool restState)						{ restFlag = restState;  }
	inline void SetProjectileState(bool projectileState)			{ projectileFlag = projectileState; }
	inline void SetTargetBoardState(bool targetBoardState)			{ targetBoardFlag = targetBoardState; }
	inline void SetInAtmosphereState(bool inAtmosphereState)		{ inAtmosphereFlag = inAtmosphereState; }
	inline void SetFirstColState(bool firstColState)				{ firstColFlag = firstColState; }
...
protected:
	...
	bool				restFlag;
	bool				projectileFlag;
	bool				inAtmosphereFlag;
	bool				targetBoardFlag;
	bool				firstColFlag;
