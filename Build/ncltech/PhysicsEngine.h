...
public:
	...
	//Yupei
	bool IsAtmosphered() { return m_IsAtmosphere; }
	void SetAtmosphere(bool atmosphere) { m_IsAtmosphere = atmosphere; }

	bool GetVisableState() { return visableStateFlag; }
	void SetVisableState(bool visableState) { visableStateFlag = visableState; }
	
	float				GetScore() { return m_score; }
	void SetScore(float tempScore) { m_score = tempScore; }
